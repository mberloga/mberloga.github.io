(function e(t, n, r) {
  ...
  "c:\\work\\particles-animation\\src\\js\\particles\\index.js": [function(require, module, exports) {
    ...
    Particle = function(posx, posy, radius) {
      ...
      if (radius < 0) {
        throw "ÐžÑˆÐ¸Ð±ÐºÐ°! Ð”Ð°Ð½ Ñ€Ð°Ð´Ð¸ÑƒÑ Ñ‡Ð°ÑÑ‚Ð¸Ñ†Ñ‹ " + radius + " Ð¿Ð¸ÐºÑÐµÐ»ÐµÐ¹, Ð½Ð¾ Ñ€Ð°Ð´Ð¸ÑƒÑ Ð½Ðµ Ð¼Ð¾Ð¶ÐµÑ‚ Ð±Ñ‹Ñ‚ÑŒ Ð¾Ñ‚Ñ€Ð¸Ñ†Ð°Ñ‚ÐµÐ»ÑŒÐ½Ñ‹Ð¼!";
      }
      ...
      this.status = 'standing'; // Ð¡Ñ‚Ð°Ñ‚ÑƒÑÑ‹: standing || moving

      this.direction = this.position;

      this.speed = 1; // 1 Ð¿Ð¸ÐºÑÐµÐ»ÑŒ Ð² ÑÐµÐºÑƒÐ½Ð´Ñƒ
