...
jQuery(document).ready(function() {
	...
	jQuery(".mber-switch-btn input:checkbox").on('click', function() {
		...
		if($('.mber-switch-btn input:checkbox:checked').length){
			jQuery('.mber-tech, .mber-adm-29-10-2021, .mber-adm-21-12-2021, .mber-adm-05-04-22, .mber-adm-05-10-2022, .mber-adm-24-11-2022, .mber-adm-13-12-2023, .mber-adm-20-03-2024, .mber-adm2-27-12-2023, .mber-adm2-16-02-2024, .mber-adm2-18-04-2024, .mber-ug-23-05-2022, .mber-ug-01-08-2022, .mber-ug-11-07-2023, .mber-dpi, .mber-spasibo, .mber-html-text-khmel, .mber-sledy, .mber-zoo-geo-dv, .mber-bsvmg, .mber-hozyain-lesa, .mber-yug-dv, .mber-doklad-2023, .mber-uchet-okhot, .mber-pamyatka, .mber-pfpkpep, .mber-sichinava, .mber-html-text-23-08-2023, .mber-html-text-23-11-2023, .mber-html-text-06-06-2024, .mber-html-text-page, .mber-project-detail, .mber-portfolio-content, .mber-image-page, .mber-soundcloud-page, .mber-vimeo-content, .mber-youtube-video-page, .mber-home-main-content, .weekend-mode-hide, .mber-slider-page').addClass("hidepage");
	...
	jQuery(".all-content-wrap.dpi").click(function() {
		jQuery('.mber-dpi').toggleClass("showpage");
		jQuery('.mber-news-content').toggleClass("hidepage");
	})
	jQuery(".image-close, .close").click(function() {
		jQuery('.mber-news-content').removeClass("hidepage");
		jQuery('.mber-dpi').removeClass("showpage");
	});
	...
	jQuery("a.sledy").click(function() {
		jQuery('.mber-sledy').toggleClass("showpage");
		jQuery('.mber-news-content').toggleClass("hidepage");
	})
	jQuery(".image-close, .close").click(function() {
		jQuery('.mber-news-content').removeClass("hidepage");
		jQuery('.mber-sledy').removeClass("showpage");
	});
	
	jQuery("a.zoo-geo-dv").click(function() {
		jQuery('.mber-zoo-geo-dv').toggleClass("showpage");
		jQuery('.mber-news-content').toggleClass("hidepage");
	})
	jQuery(".image-close, .close").click(function() {
		jQuery('.mber-news-content').removeClass("hidepage");
		jQuery('.mber-zoo-geo-dv').removeClass("showpage");
	});
	
	jQuery("a.hozyain-lesa").click(function() {
		jQuery('.mber-hozyain-lesa').toggleClass("showpage");
		jQuery('.mber-news-content').toggleClass("hidepage");
	})
	jQuery(".image-close, .close").click(function() {
		jQuery('.mber-news-content').removeClass("hidepage");
		jQuery('.mber-hozyain-lesa').removeClass("showpage");
	});
	
	jQuery("a.bsvmg").click(function() {
		jQuery('.mber-bsvmg').toggleClass("showpage");
		jQuery('.mber-news-content').toggleClass("hidepage");
	})
	jQuery(".image-close, .close").click(function() {
		jQuery('.mber-news-content').removeClass("hidepage");
		jQuery('.mber-bsvmg').removeClass("showpage");
	});
	
	jQuery("a.yug-dv").click(function() {
		jQuery('.mber-yug-dv').toggleClass("showpage");
		jQuery('.mber-news-content').toggleClass("hidepage");
	})
	jQuery(".image-close, .close").click(function() {
		jQuery('.mber-news-content').removeClass("hidepage");
		jQuery('.mber-yug-dv').removeClass("showpage");
	});
	...
	jQuery("a.uchet-okhot").click(function() {
		jQuery('.mber-uchet-okhot').toggleClass("showpage");
		jQuery('.mber-news-content').toggleClass("hidepage");
	})
	jQuery(".image-close, .close").click(function() {
		jQuery('.mber-news-content').removeClass("hidepage");
